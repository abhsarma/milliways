<script>
	...
	import multiverseMatrix, { drawResultsMenu } from './components/multiverseMatrix.js';
	import { cell, groupPadding, outVisWidth, margin, header1 } from './components/dimensions.js'
