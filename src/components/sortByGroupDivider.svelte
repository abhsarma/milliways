<script>
	...
	export let h
	$: ch = h > windowHeight ? windowHeight : h
...
<g class="grouped-sort-divider {boundaries.length - 1}" 
	...
	<line x1=0 y1={gridNamesHeight} x2=0 y2={h} style="stroke: #666; stroke-width: {dividerWidth}"></line>
	<g class="grouped-sort-divider-icon" 
		transform="translate(0, {(ch + gridNamesHeight - (iconSize * 4/3))/2})">
